        ...
        <div>
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-reguler text-gray-900 dark:text-white">
                    Riwayat Pengajuan <span className="font-bold">Pendaftaran</span> Seminar KP
                </h3>
                <button
            ...
            {/* Revision Modal */}
            <Revisi
                title="Pengajuan Pendaftaran Seminar Kp Anda"
            ...
            <Diterima
                title="Pengajuan Pendaftaran Seminar Kp Anda"
                text="Informasi Diseminasi KP selanjutnya ada distatus !"
